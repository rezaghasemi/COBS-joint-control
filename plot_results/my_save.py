...
def load_result(pth):
    ...
    ## changed path for my PC /media/reza/Tempo/github/COBS-joint-control/Results/rl_results
    root = os.path.join('/media/reza/Tempo/github/COBS-joint-control/Results/rl_results', pth)
    print('root is :', root)
    rewards = []
    hvacs = []
    hcoils = []
